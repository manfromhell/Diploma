...
<link href="<c:url value="/resources/css/jquery-ui.css" />"
	rel="stylesheet" type="text/css" />
	<link href="<c:url value="/resources/css/resizable.css" />"
	rel="stylesheet" type="text/css" />
...
<script src="<c:url value="/resources/js/resizable-tables.js" />"></script>
<script src="<c:url value="/resources/js/colResizable-1.2.min.js" />"></script>
